...
# A generic gateway header proves a server cache but cannot identify its product exclusively.
...
def detect_cache_layers(
    ...
    gateway_evidence = matching_header_evidence(headers, NON_NAMESPACED_HOST_PREFIXES)
    if server_signal["value"] == "unknown" and gateway_evidence:
